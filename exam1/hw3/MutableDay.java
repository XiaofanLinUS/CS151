public class MutableDay
{
   ...
   */
   ...
   /**
    * Throws an IllegalStateException if the current state is not valid.
    */
   private void checkValid()
   {
	   if (year == 0 || month <= 0 || month > 12 || date <= 0 || date > daysPerMonth(year, month))
		   	throw new IllegalStateException(year + "-" + month + "-" + date);
   }
   ...
   */
   public int daysFrom(MutableDay other)
   {
      ...
      int n = 0;
      MutableDay d = new MutableDay(year, month, date);
