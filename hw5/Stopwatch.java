...
public class Stopwatch implements MoveableShape
{
    ...
    * 
    * @param x
    *           the left of the bounding circle
    * @param y
    *           the top of the bounding circle
    * @param radius
    ...
    * @param startX
    *           the starting x value of the pointer
    * @param startY
    *           the starting y value of the pointer
    * @param length
    *           the length of the pointer
    * @param degree
    *           the degree between the pointer and a vertical line
    * @param aColor
    ...
    * Violet program: http://horstmann.com/violet/ Dr. Horstmann, Cay S.
    * Horstmann (http://horstmann.com), is the author of Violet Get a path of an
    * arrow head
    * 
    * @param startX
    *           the x value of the head
    * @param startY
    *           the y value of the head
    * @param endX
    *           the x value of the tail
    * @param endY
    *           the y value of the tail
    * @param arrowLength
    *           the length of axis of the arrow
