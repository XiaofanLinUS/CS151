...
public class Dial implements Icon
{
    ...
    * 
    * @param aRadius
    *           the radius of this icon
    * @param aThirdTick
    *           true if the icon needs to have the third ticker
    * @param aColor
    *           the color of this dial
    */
    ...
    * 
    * @param number
    *           true if the dial needs to have a number label besides a ticker
    * @param tickers
    *           the number of tickers
    * @param length
    *           the length of tickers
    * @param x
    *           the left of the bounding circle
    * @param y
    *           the top of the bounding circle
   ...
   public void drawTickers(boolean number, int tickers, int length, int x, int y, Graphics2D g2)
   {
      ...
      if (number)
      {
         ...
         for (int i = 0; i < tickers; i++)
         {
            ...
            /*
             * The following code is cited from a book, Object-Oriented Design
             * and Patterns Dr. Horstmann, Cay S. Horstmann
             * (http://horstmann.com), is the author of the book
             */
